...
const screens: Screen[] = [
  ...
  },
  {
    ...
    dynamicFields: [
      { field: 'gender', screenId: 'gender', type: 'answer' },
      {
        ...
        type: 'conditional',
        condition: { screenId: 'isSingleParent', expectedChoiceId: 1 },
      },
    ],
    next: {
      1: 'isTendToOverthink',
  ...
  },
  {
    ...
    next: {
      1: [
        {
          screenId: 'whatIsMostImportant',
          condition: { screenId: 'isTendToOverthink', expectedChoiceId: 1 },
        },
        {
          screenId: 'isEmotionalControlTricky',
          condition: { screenId: 'isTendToOverthink', expectedChoiceId: 2 },
        },
      ],
    },
    choices: [
  ...
  },
  {
    ...
    dynamicFields: [
      { field: 'gender', screenId: 'gender', type: 'answer' },
      {
        field: 'who have children',
        type: 'conditional',
        condition: { screenId: 'isParent', expectedChoiceId: 1 },
      },
    ],
    next: {
